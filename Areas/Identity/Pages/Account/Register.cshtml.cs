...
namespace IssueTracker.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        private IssueTrackerUser CreateUser()
        {
            ...
            {
                throw new InvalidOperationException($"Can't create an instance of '{nameof(IssueTrackerUser)}'. " +
                    $"Ensure that '{nameof(IssueTrackerUser)}' is not an abstract class and has a parameterless constructor, or alternatively " +
